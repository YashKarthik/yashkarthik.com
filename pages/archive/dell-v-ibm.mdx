...
export const meta = {
	shortName: 'dell-v-ibm',
	title: "How Dell dethroned IBM",
	date: 'Jul 28, 2022',
	description: "",
    long_desc: "In the 1970s personal computer was was an unfamiliar idea with the American people. Only businesses and universities used computers. IBM dominated this arena with 60% market share. As the personal computer market emerged in the early 80s, IBM was the time-tested"
}
