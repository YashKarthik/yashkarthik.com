...
export const meta = {
	...
	date: 'Feb 11, 2022',
	description: '',
    content: "NFTs and copyright, both do the same thing - establish a connection between the asset and the creator, providing them with ownership over their work, and enabling uniqueness. The only difference being that NFTs are not (yet) recognized by law."
}
