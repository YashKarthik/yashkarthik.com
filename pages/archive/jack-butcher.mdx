...
import venn_svg from "../../public/blog-assets/venn.svg"

export const meta = {
	shortName: 'jack-butcher',
	title: "How Jack Butcher Productized Himself",
	date: 'Aug 11, 2022',
	description: 'Escape competition through autheticity - Naval Ravikant',
    long_desc: "Today Jack Butcher has an online audience of over 500k, earns $100,000 a month, and runs an infinitely scalable business. But just 4 years ago, in 2018, he was burnt out running an ad agency serving corporate clients. The insight behind this transition"
}
...
<OptimizedImage
    src={venn_svg}
    alt="Venn Diagram representing Jack relative to the design industry."
/>
