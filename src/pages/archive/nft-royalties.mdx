...
export const meta = {
	shortName: 'nft-royalties',
	title: "How NFT Royalties Actually Work",
	date: 'Aug 19, 2022',
	description: 'Escape royalties through Sudoswap - an angry trader',
    long_desc: "I first read about Sudoswap on my Twitter feed. It was an angry tweet advocating for nft royalties. The part about royalties caught my eye. I had no idea that royalties could even be excluded. This led me down the rabbit hole of token standards (ERC-20, ERC-721 etc)"
}
