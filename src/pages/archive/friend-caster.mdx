...
import idea_cast from "../../public/blog-assets/idea-cast.png"

export const meta = {
	shortName: 'friend-caster',
	title: "How it Works: Friendcaster",
	date: 'Sep 9, 2022',
	description: 'Ideas are cheap, execution is hard',
    long_desc: "I was just scrolling on Farcaster and this cast scrolled onto my feed. I clicked on the link to see what Chirpty was, and felt that this would be a perfect project for me. It's simple, but not too simple."
}
...
<OptimizedImage
    src={idea_cast}
    alt="The cast that gave me the idea to build Friendcaster."
/>
