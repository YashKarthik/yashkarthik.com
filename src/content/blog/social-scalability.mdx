...
description: "Exploring why humans dominate the world. To effectively cooperate, we organize
ourselves into centralized hierarchies, which are efficient within a country but not universal.
Blockchain-based coordination, while less efficient, operates across borders without relying on
trust, could be used to replace traditionally centralized institutions."
topics: ["cryptocurrency", "bitcoin", "permissionless"]
