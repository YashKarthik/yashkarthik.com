...
description: "On the Lens Protocol. How it uses the immutability and interoperability of NFTs to
represent a social graph; and how it takes NFTs beyond JPEGs, leveraging their inherent \"programmability\"."
