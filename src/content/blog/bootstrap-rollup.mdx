...
description: "Incentivizing users to use rollups via token drops and transaction fee subsidies.
Subsidizing transactions to attract users could help rollups get enough users such that the fee
per user falls down drastically."
topics: ["cryptocurrency", "ethereum", "scaling", "economics"]
...
![Image about bootstrapping using tokens](/blog-assets/bootstrap-token.png "Bootstrapping using tokens")
...
![Image aboutl bootstrapping by subsidizing](/blog-assets/bootstrap-sub-tx.svg "Bootstrapping by subsidizing")
