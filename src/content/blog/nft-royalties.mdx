...
description: "Digging into how NFT royalties are implemented. Without NFT
marketplaces there's no way to distinguish between a sale and a transfer to a cold wallet."
